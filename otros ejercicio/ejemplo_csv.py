...
# Supongamos que tienes un diccionario con información que quieres guardar en un CSV
mi_diccionario = {
    'nombre': 'Juan',
    'edad': 30,
    'profesion': 'Ingeniero'
...
# Nombre del archivo CSV que vamos a crear
nombre_archivo = 'mi_diccionario.csv'

# Abrimos el archivo en modo escritura
with open(nombre_archivo, 'w', newline='') as archivo_csv:
    # Creamos un objeto escritor CSV
    escritor = csv.DictWriter(archivo_csv, fieldnames=mi_diccionario.keys())

    # Escribimos la fila de encabezados (nombres de las columnas)
    escritor.writeheader()

    # Escribimos los datos del diccionario como una fila en el CSV
    escritor.writerow(mi_diccionario)

print(f"Se ha creado el archivo '{nombre_archivo}' con los datos del diccionario.")
